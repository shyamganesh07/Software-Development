...
app.post('/makePayment', (req, res) => {
    ...
    if (hotel) {
        res.json({ success: true, message: `Payment successful! Booking confirmed for ${hotel.name} via ${paymentMethod}.` });
    } else {
        res.json({ success: false, message: "Payment failed. Hotel not found." });
    }
});
